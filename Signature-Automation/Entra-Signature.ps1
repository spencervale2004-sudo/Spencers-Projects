...
#####-- Details of created Entra Application --#####
    $Tenantid = "Selected users Tenant ID"
    $ClientId = "Entra App Client ID" # App will only need User.Read.All and Organization.Read.All
    $ClientSecret = "Client Secret of the Entra App" # If doing multiple Tenants you will need to decide how the powershell will get this value (Along with Tenant ID)
